...
export async function getFullName(letter) {
  ...
  if (error) {
    ...
    return { Tip: letter, SeishikiName: 'Not found', explanation: '該当のTipがありません:'+ error.message };
  }
  ...
  if (data.length > 0) {
    ...
    return { Tip: letter, SeishikiName: 'Not found', explanation: '該当のTipがありませんR:'+ error.message };
  }
}
